                                ...
                                <a class="card rounded-0 shadow product-item text-decoration-none text-reset" href="./?p=products/view_product&id=<?= $row['id'] ?>">
                                    ...
                                    <div class="card-body">
                                        <div style="line-height:1em">
                                            <div class="card-title w-100 mb-0">Ativan</div>
                                            <div class="card-description w-100">Lorazepam</small></div>
                            ...
                            <div class="col">
                                <a class="card rounded-0 shadow product-item text-decoration-none text-reset" href="./?p=products/view_product&id=<?= $row['id'] ?>">
                                    <div class="position-relative">
                                        ...
                                        <div class="position-absolute bottom-1 right-1" style="bottom:.5em;right:.5em">
                                            <span class="badge badge-light bg-gradient-light border text-dark px-4 rounded-pill">10.00</span>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                        <div style="line-height:1em">
                                            <div class="card-title w-100 mb-0">Amoxicillin</div>
                                            <div class="card-description w-100"><small class="text-muted">Amoxil</small></div>
                                            <div class="card-description w-100"><small class="text-muted">Stock: 50</small></div>
                                        </div>
                                    </div>
                                </a>
                            </div>
                            <div class="col">
                                <a class="card rounded-0 shadow product-item text-decoration-none text-reset" href="./?p=products/view_product&id=<?= $row['id'] ?>">
                                    <div class="position-relative">
                                        ...
                                        <div class="position-absolute bottom-1 right-1" style="bottom:.5em;right:.5em">
                                            <span class="badge badge-light bg-gradient-light border text-dark px-4 rounded-pill">50.00</span>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                        <div style="line-height:1em">
                                            <div class="card-title w-100 mb-0">Mefenam</div>
                                            <div class="card-description w-100"><small class="text-muted"></small>Ponstel</div>
                                            <div class="card-description w-100"><small class="text-muted">Stock: 100</small></div>
                                        </div>
                                    </div>
                                </a>
                            </div>
                            <div class="col">
                                <a class="card rounded-0 shadow product-item text-decoration-none text-reset" href="./?p=products/view_product&id=<?= $row['id'] ?>">
                                    <div class="position-relative">
                                        ...
                                        <div class="position-absolute bottom-1 right-1" style="bottom:.5em;right:.5em">
                                            <span class="badge badge-light bg-gradient-light border text-dark px-4 rounded-pill">30.00</span>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                        <div style="line-height:1em">
                                            <div class="card-title w-100 mb-0">Gemtesa</div>
                                            <div class="card-description w-100"><small class="text-muted">Vibegron</small></div>
                                            <div class="card-description w-100"><small class="text-muted">Stock: 60</small></div>
                                        </div>
                                    </div>
                                </a>
                            </div>
